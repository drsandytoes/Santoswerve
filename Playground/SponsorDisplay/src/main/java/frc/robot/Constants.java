...
public final class Constants {
  ...
  public static final class LEDConstants {
    ...
    public static final class LEDRegions {
      public static final Rectangle kUpperHalf = new Rectangle(0, 0, kMatrixWidth, kMatrixHeight/2);
      public static final Rectangle kLowerHalf = new Rectangle(0, kMatrixHeight/2, kMatrixWidth, kMatrixHeight/2);
    }
  }

  public static final class SponsorDisplay {
    public static final double kPanelDelay = 5.0; // Seconds
  }
