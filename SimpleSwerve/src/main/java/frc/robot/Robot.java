...
public class Robot extends LoggedRobot {
    ...
    private PowerDistribution m_main, m_secondary;
    ...
    public void robotInit() {
        ...
        if (isReal()) {
            ...
            m_main = new PowerDistribution(1, ModuleType.kCTRE); // Enables power distribution logging
            m_secondary = new PowerDistribution(2, ModuleType.kCTRE);
        } else {
